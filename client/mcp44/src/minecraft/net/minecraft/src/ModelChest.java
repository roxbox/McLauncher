...
public class ModelChest extends ModelBase
{
    ...
    public ModelChest()
    {
        chestLid = (new ModelRenderer(this, 0, 0)).func_35968_a(64, 64);
